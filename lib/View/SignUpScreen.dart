...
class SignUpScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final countryProvider = Provider.of<SingupController>(context, listen: false);
                        ...
                        decoration: InputDecoration(
                          ...
                          contentPadding: EdgeInsets.symmetric(
                            ...
                            vertical: 8,
                              ...
                              GestureDetector(
                                onTap: () => _showSelectionDialog(context: context,
                                  title: "Select a Country",
                                  items: countryProvider.countries,
                                  getDisplayName: (country) => country.CountryName,
                                  onItemSelected: (country) {
                                    countryProvider.selectCountry(country.CountryName, country.CountryId);
                                  }
                                  ),
                                child: TextField(
                              ...
                              GestureDetector(
                                onTap: () =>_showSelectionDialog(context: context,
                                    ...
                                    onItemSelected: (state) {
                                      countryProvider.selectState(state.stateName, state.stateId);
                                    }
                                ),
                                child: TextField(
